...
var Board = PCBServer.GetCurrentPCBBoard;
      if (Board != Null)
        ...
        */
        ...
        SquareTrack1.X1         = (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack1.Y1         = (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack1.X2         = (-Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4)) - (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack1.Y2         = (-Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4)) + (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        ...
        SquareTrack2.X1         = (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack2.Y1         = (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack2.X2         = (-Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack2.Y2         = (-Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        ...
        SquareTrack3.X1         = (-Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4)) - (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack3.Y1         = (-Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4)) + (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack3.X2         = (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4)) - (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack3.Y2         = (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4)) + (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        ...
        SquareTrack4.X1         = (-Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack4.Y1         = (-Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack4.X2         = (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4))   + (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4));
        SquareTrack4.Y2         = (Pad.HoleSize/2)*parseFloat(sin(Pad.HoleRotation/57.296).toFixed(4))   - (Pad.HoleSize/2)*parseFloat(cos(Pad.HoleRotation/57.296).toFixed(4));
