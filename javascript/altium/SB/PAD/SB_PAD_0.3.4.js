//¬ыт€нутые повернутые квадратные Rotation = -321; 43 (в PCB файле) и овальные (?) пады когда повернуты на произвольный градус стро€тс€ не верно      Ќайти при каких значени€х параметров по€вл€етс€ ошибка
...
var Board = PCBServer.GetCurrentPCBBoard;
      if (Board != Null)
       ...
       //Put this Arc in the Board object
        ...
        //For square pad with rotation hole and with pad rotation
        else {
        ...
        SquareTrack1.Y1         = (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) + (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        SquareTrack1.Y2         = (-Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) + (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        if(Pad.HoleWidth)
        {
                         SquareTrack1.X1         = (Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
                         SquareTrack1.X2         = (-Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }

        else
        {
                         SquareTrack1.X1         = (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
                         SquareTrack1.X2         = (-Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }
        ...
        //SquareTrack Left
        SquareTrack2.Y1         = (-Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        SquareTrack2.Y2         = (-Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));

        if(Pad.HoleWidth)
        {
                         SquareTrack2.X1         = (-Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  - (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
                         SquareTrack2.X2         = (-Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  + (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }

        else
        {
                         SquareTrack2.X1         = (-Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
                         SquareTrack2.X2         = (-Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }
        ...
        //SquareTrack Right
        SquareTrack3.Y1         = (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) + (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        SquareTrack3.Y2         = (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) + (-(Pad.HoleSize/2))*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));

        if(Pad.HoleWidth)
        {
                         SquareTrack3.X1         = (Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
                         SquareTrack3.X2         = (Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (-(Pad.HoleWidth/2))*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }

        else
        {
                         SquareTrack3.X1         = (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
                         SquareTrack3.X2         = (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4)) - (-(Pad.HoleSize/2))*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }
        ...
        SquareTrack4.Y1         = (-Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  - (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        SquareTrack4.Y2         = (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))   - (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));


        if(Pad.HoleWidth)
        {
        SquareTrack4.X1         = (-Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  + (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        SquareTrack4.X2         = (Pad.HoleWidth/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))   + (Pad.HoleWidth/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }

        else
        {
        SquareTrack4.X1         = (-Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))  + (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        SquareTrack4.X2         = (Pad.HoleSize/2)*parseFloat(Math.cos(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4))   + (Pad.HoleSize/2)*parseFloat(Math.sin(Pad.HoleRotation/57.296+Pad.Rotation/57.296).toFixed(4));
        }
